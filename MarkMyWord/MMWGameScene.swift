...
//        }
        ...
        let buttonResizeArr = [playButton, newTilesButton, passButton, pauseButton, optionsButton] // [playButton, newTilesButton, passButton, optionsButton]
...
//                    numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
                    ...
                    if playAnotherWord + (playerLevel * 3) > 5 && numLettersRemaining > 0 {
                        ...
                        delay(8.0) { // allow time for first word play
                            ...
                            if self.playAILetters().playedWholeWord == true {
                                ...
                                if wordAttemptsPlayed == 2 && numLettersRemaining > 0 && mmwGameScene.secondsLeft > Int(9) && gameIsSuspended == false {
    ...
    //                    pauseTime +=   8  // (6.0 - Double(numLettersRemaining) ) * 5.75  //  5 + 3
    //                    delay(pauseTime) {
    //                        //   // PLAY SECOND SET OF LETTERS
    //                        if self.playAILetters().playedWholeWord == true {
    //
    //                            numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
    //
    ...
    //                            if playAnotherWord + (playerLevel * 3) > 9 && numLettersRemaining > 0 {
    //                                //pauseTime += 3.0
    //                                delay( 8.0) {  //     (5.0 - Double(numLettersRemaining) ) * 5.75) {
    //
    //                                    self.playAILetters() // Play third whole word, or partial
    //                                    delay(3) {
    //                                        numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
    ...
    func playAILetters() -> (playedWholeWord: Bool, playedPartialWord: Bool){
        ...
        if debugMode == true { print(">> numLockedTilesSearched : \(numLockedTilesSearched++), checkForValidWordsAISearchedTRUE : \(checkForValidWordsAISearchedTRUE), allPossiblePartialWordPlays: \(allPossiblePartialWordPlays.count), allPossibleWholeWordPlays: \(allPossibleWholeWordPlays.count) playBtnPlay loadWords() mmwGameScene") }
...
//                    })
    ...
    func subtractTilesRemainingOnBoard() {
        ...
        delay ( (Double(tileDelay) * 0.5) +  5.0 ) { // Double(++numLetterTilesRemaining) ) {
            self.gameIsOver()
        }
    }
...
//    private var gameIsSuspended = false
//
//    var foundValidWordOnTurn = false
//    var numWordsPlayedInTurn = 0
//
...
//            }
//
//            if wordAttemptsPlayed == 1 && numLettersRemaining > 0 && mmwGameScene.secondsLeft > Int(12) {
//
//                numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
//
//                playAnotherWord = Int(arc4random_uniform(10))
//
//                if playAnotherWord + (playerLevel * 3) > 7 && numLettersRemaining > 0 {
//
//                    delay(8.0) { // allow time for first word play
//                        //Play second whole word, or partial
//                        if self.playAILetters().playedWholeWord == true {
...
//                            }
//
//                            if wordAttemptsPlayed == 2 && numLettersRemaining > 0 && mmwGameScene.secondsLeft > Int(10) {
//
//                                numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
//
//                                playAnotherWord = Int(arc4random_uniform(10))
//
//                                if playAnotherWord + (playerLevel * 3) > 10 && numLettersRemaining > 0 {
//
//                                    delay(pauseTime) { // pause to allow second word play
//                                        self.playAILetters() // Play third whole word, or partial
//
...
//        }
//
//        else { // 0 tiles left so pause and change turn
//            mmwGameSceneViewController.consecutivePasses++
//            delay(3.0){
//                self.changePlayerTurn()
//            }
...
//                // checks for playable valid whole word in player tiles
//                ////////////////////////
//                var tileAIWordCheck = checkForValidWordsAI(lockedTile.gridXEnd, gridYSpot: lockedTile.gridYEnd, permutationsToPlay: permutationsToPlay, lookHorizontal: true)
//
//                if (tileAIWordCheck.allFoundPartialWordPlaysAtLockedTile.count > 0) {
//
//                    allPossiblePartialWordPlays += tileAIWordCheck.allFoundPartialWordPlaysAtLockedTile
...
//                }
//
//                tileAIWordCheck = checkForValidWordsAI(lockedTile.gridXEnd, gridYSpot: lockedTile.gridYEnd, permutationsToPlay: permutationsToPlay, lookHorizontal: false)
//
//                if (tileAIWordCheck.allFoundPartialWordPlaysAtLockedTile.count > 0) {
//
//                    allPossiblePartialWordPlays += tileAIWordCheck.allFoundPartialWordPlaysAtLockedTile
...
//            if allPossibleWholeWordPlays.count >= 1 {
//                let wordToPlay = Int(arc4random_uniform(UInt32(allPossibleWholeWordPlays.count)))
//                playAIPlaceholderTilesToBoard (allPossibleWholeWordPlays[wordToPlay])
//                playedWholeWord = true
//            }
//            else {
//                var notAnEdgeWord = true
...
//                    }
//                    if notAnEdgeWord == true {
//                        playAIPlaceholderTilesToBoard (partialWord)
//                        playedPartialWord = true
//                        break
//                    }
//                }
...
//
//            dispatch_async(dispatch_get_main_queue(), {
//                print("hello from explosion() thread executed as dispatch")
//            })
//        })
//    }
//
...
//        let tileDelay = tilesToSubtractBoard >= tilesToSubtract ? tilesToSubtractBoard : tilesToSubtract
//
//        delay ( (Double(tileDelay) * 0.5) +  4.0 ) { // Double(++numLetterTilesRemaining) ) {
//            self.gameIsOver()
//        }
//    }
//
...
//    
//    var gameIsPaused = true
//    private var gameIsSuspended = true
//    
//    var foundValidWordOnTurn = false
//    var numWordsPlayedInTurn = 0
//
...
////                var playAnotherWord = Int(arc4random_uniform(10))
////                
////                if playAnotherWord + (playerLevel * 3) > 7 && numLettersRemaining > 0 && mmwGameScene.secondsLeft > 8 {
////                    pauseTime += 3.0  //  5 + 3
////                    delay(pauseTime) {
////                        // Play second whole word, or partial
////                        if self.playAILetters().playedWholeWord == true {
...
////                            numLettersRemaining = (mmwGameSceneViewController.playerArray[mmwGameSceneViewController.playerTurn-1].playerLetterGrid).numLetterTilesInGrid()
////                            
////                            if playAnotherWord + (playerLevel * 3) > 10 && numLettersRemaining > 0 && mmwGameScene.secondsLeft > 5 {
////                                //pauseTime += 3.0
////                                delay(pauseTime) {
////                                    self.playAILetters() // Play third whole word, or partial
////                                    delay(3) {
